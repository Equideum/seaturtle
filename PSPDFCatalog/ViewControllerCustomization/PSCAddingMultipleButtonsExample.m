...
- (void)imageButtonPressed:(PSCAutoResizeButton *)button {
    ...
    if (image) {
        ...
        [self presentViewController:imagePreviewController options:@{ PSPDFPresentationInNavigationControllerKey: @YES, PSPDFPresentationCloseButtonKey: @YES } animated:YES sender:button completion:NULL];
    }
}
