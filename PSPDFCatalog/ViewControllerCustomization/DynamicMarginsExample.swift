...
class DynamicMarginsExample: PSCExample {
    ...
    override func invoke(with delegate: PSCExampleRunnerDelegate) -> UIViewController? {
        ...
        let configuration = PSPDFConfiguration { builder in
            ...
            builder.userInterfaceViewMode = .always
            builder.thumbnailBarMode = .none
        }
        let pdfController = CustomUserInterfaceController(document: document, configuration: configuration)
        return pdfController
    }

    // MARK: - View controller

    class CustomUserInterfaceController: PSPDFViewController {
        ...
        private func updateCongigurationForBottomBar() {
            ...
            updateConfiguration { builder in
                builder.additionalScrollViewFrameInsets = UIEdgeInsets(top: 0, left: 0, bottom: bottomBarInset, right: 0)
            }
    ...
    class CustomBottomBar: UIView {
        ...
        private func setUpViews() {
            backgroundColor = UIColor.pspdf().withAlphaComponent(0.7)
