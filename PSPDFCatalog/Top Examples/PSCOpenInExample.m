...
- (instancetype)init {
    if ((self = [super init])) {
        ...
        self.contentDescription = @"Displays all files in the Inbox directory via the PSPDFDocumentPickerController.";
...
- (nullable UIViewController *)invokeWithDelegate:(id<PSCExampleRunnerDelegate>)delegate {
    ...
    PSPDFDocumentPickerController *documentSelector = [[PSPDFDocumentPickerController alloc] initWithDirectory:nil includeSubdirectories:YES library:PSPDFKit.sharedInstance.library];
