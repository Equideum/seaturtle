...
final class PageScalingExample: PSCExample {
...
private final class PageScalingPDFViewController: PSPDFViewController {
    ...
    private func scale(_ sender: UIBarButtonItem) {
        ...
        let scaledDocumentURL = PSCTempFileURLWithPathExtension("scaled", "pdf")
...
extension PageScalingPDFViewController: PSPDFProcessorDelegate {
