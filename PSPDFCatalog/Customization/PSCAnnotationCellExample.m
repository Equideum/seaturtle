...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        [_shareButton setTitleColor:[UIColor colorWithRed:0.9 green:0.0 blue:0.0 alpha:1.] forState:UIControlStateNormal];
        [_shareButton setTitleColor:[UIColor colorWithRed:0.7 green:0.0 blue:0.0 alpha:1.] forState:UIControlStateHighlighted];
