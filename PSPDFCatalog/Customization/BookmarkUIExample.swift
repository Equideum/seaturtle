...
class BookmarkUIExample: PSCExample {
...
class CustomBookmarkPDFViewController: PSPDFViewController {

    // MARK: Lifecycle
    public override func commonInit(with document: PSPDFDocument?, configuration: PSPDFConfiguration) {
    ...
    @objc func bookmarkButtonTapped() {
        ...
        if bookmarkManager.bookmarkForPage(at: pageIndex) == nil {
            ...
            let mutableBookmark = PSPDFMutableBookmark(pageIndex: pageIndex)
